...
export interface Wire { x1: number; y1: number; x2: number; y2: number; main: boolean; ids?: number[]; kind?: 'mar' | 'drop' | 'bus' | 'kid'; pars?: number[]; kids?: number[]; kid?: number; hops?: number[]; }
